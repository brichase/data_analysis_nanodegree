...
def test():
    #write_updates('san-diego-tijuana_mexico.osm',  'san-diego-tijuana_mexico_update.osm', 'san-diego-tijuana_mexico_update.log')
    write_updates('example.osm',  'example_update.osm', 'example.log')
